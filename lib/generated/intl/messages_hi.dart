...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "स्तर ${name}";

  static String m1(seconds) => "${seconds} सेकंड\nजीवित रहें";

  static String m2(name) => "${name} . द्वारा रचित";

  static String m3(appUrl, seconds) =>
      "मैं ${seconds} सेकंड तक चला। आप कितने समय तक टिक सकते हैं?\n\n${appUrl}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "appDescription": MessageLookupByLibrary.simpleMessage(
            "क्या आप हमेशा शौच करते समय इतने ऊब जाते हैं? बदबू खत्म करो।\nअपने बाथरूम को एक जादुई अभयारण्य में बदल दें और शौचालय निंजा बनें\nबस शौचालय से मत गिरो, यह गंदा है! कब तक तुम अस्तित्व में रह सकते हो?"),
        ...
        "overlayHelpStayOnMapText":
            MessageLookupByLibrary.simpleMessage("शौचालय पर रहो"),
        "overlayHelpSurviveText": m1,
        "overlayHelpTapToStartText":
            MessageLookupByLibrary.simpleMessage("शुरू करने के\nलिए टैप करें"),
        "overlayHelpTapToTurnText":
            MessageLookupByLibrary.simpleMessage("मुड़ने के लिए\nटैप करें"),
        "pageCreditsAuthorsSectionText":
            MessageLookupByLibrary.simpleMessage("लेखकों"),
        "pageCreditsComposedBy": m2,
        "pageCreditsImagesSectionText":
            MessageLookupByLibrary.simpleMessage("इमेजिस"),
        "pageCreditsLicensesButtonText":
            MessageLookupByLibrary.simpleMessage("लाइसेंस >"),
        "pageCreditsMusicSectionText":
            MessageLookupByLibrary.simpleMessage("संगीत"),
        "pageCreditsTitle": MessageLookupByLibrary.simpleMessage("क्रेडिट"),
        "pageGameOverHomeButtonText":
            MessageLookupByLibrary.simpleMessage("घर"),
        "pageGameOverNextButtonText":
            MessageLookupByLibrary.simpleMessage("अगला स्तर"),
        "pageGameOverRestartButtonText":
            MessageLookupByLibrary.simpleMessage("पुनः आरंभ करें"),
        "pageGameOverShareButtonText":
            MessageLookupByLibrary.simpleMessage("साझा करना"),
        "pageGameOverShareMessage": m3,
        "pageGameOverTryAgainButtonText":
            MessageLookupByLibrary.simpleMessage("पुनः प्रयास करें"),
        "pageStartContinueButtonText":
            MessageLookupByLibrary.simpleMessage("जारी रखें"),
        "pageStartCreditsButtonText":
            MessageLookupByLibrary.simpleMessage("क्रेडिट"),
