...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "${name} 级";

  static String m1(seconds) => "存活${seconds}秒";

  static String m2(name) => "由 ${name} 创作";

  static String m3(appUrl, seconds) =>
      "我持续了${seconds}的时间。你能坚持多长时间？\n\n${appUrl}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "appDescriptionShort":
            MessageLookupByLibrary.simpleMessage("把你的浴室变成一个神奇的避难所，成为马桶忍者吧!"),
        ...
        "overlayHelpStayOnMapText":
            MessageLookupByLibrary.simpleMessage("呆在马桶上"),
        "overlayHelpSurviveText": m1,
        "overlayHelpTapToStartText":
            MessageLookupByLibrary.simpleMessage("点击开始"),
        "overlayHelpTapToTurnText":
            MessageLookupByLibrary.simpleMessage("轻轻点一\n下就可以转身"),
        ...
        "pageCreditsMusicSectionText":
            MessageLookupByLibrary.simpleMessage("音乐"),
        ...
        "pageGameOverNextButtonText":
            MessageLookupByLibrary.simpleMessage("下一个水平"),
        "pageGameOverRestartButtonText":
            MessageLookupByLibrary.simpleMessage("重新开始"),
        ...
        "pageStartShuffleButtonText":
            MessageLookupByLibrary.simpleMessage("摇一摇")
      };
}
